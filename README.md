...
1. Claude에게 챕터 작성 요청 → `.md` 생성
2. Git 커밋 (`feat(ch1-1): 컴퓨팅 챕터 초안 작성`)
3. 해당 영역 dump 5~10문제 풀이
4. 틀린 문제 → Notion 오답 노트 DB 기록
5. Notion 학습 대시보드 상태 업데이트
