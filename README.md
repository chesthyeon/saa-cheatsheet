...
| 3-8 | [모니터링: CloudWatch vs CloudTrail vs Config vs X-Ray](13_comparison/ch3-8_monitoring.md) | ✅ |
| 3-9 | [IAM: 역할 vs 사용자 vs 리소스 기반 정책 vs SCP vs Permission Boundary](13_comparison/ch3-9_iam.md) | ✅ |
...
| # | 챕터 | 상태 |
|---|------|------|
| 2-1 | [비용 최적화 키워드 → 서비스 매핑](12_pattern/ch2-1_cost_optimization.md) | ✅ |
...
| 0-5 | [비용 최적화 (Cost Optimization)](10_principles/ch0-5_cost_optimization.md) | ✅ |
| 0-6 | [지속 가능성 (Sustainability)](10_principles/ch0-6_sustainability.md) | ✅ |
